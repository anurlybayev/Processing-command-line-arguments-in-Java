...
public class OptionSet {
    ...
    private ArrayList<String> unmatched = new ArrayList<String>();
    private ArrayList<OptionData> options = new ArrayList<OptionData>();
    private HashMap<String, OptionData> keys = new HashMap<String, OptionData>();

    /**
     * Constructor
     */

    OptionSet(Prefix prefix, Multiplicity defaultMultiplicity, String setName,
     ...
     *             If the <code>key</code> is <code>null</code> or unknown in
     *             this set
     */
     ...
     *         <p>
     * @throws IllegalArgumentException
     *             If the <code>key</code> is <code>null</code> or a key with
    ...
    /**
     * Add a non-value option with the given key and multiplicity, and the
     * default prefix
     * <p>
     * 
     * @param key
     ...
     * @throws IllegalArgumentException
     *             If the <code>key</code> is <code>null</code> or a key with
     *             this name has already been defined or if
     *             <code>multiplicity</code> is <code>null</code>
     */

    public OptionSet addOption(String key, Multiplicity multiplicity) {
        return addOption(key, false, Separator.NONE, false, multiplicity);
    }
    ...
    public OptionSet addOption(String key, Separator separator) {
     ...
     *             If the <code>key</code> is <code>null</code> or a key with
     *             this name has already been defined or if
     *             <code>separator</code> or <code>multiplicity</code> are
     *             <code>null</code>
     */
    ...
    /**
     * 
     * Add a value option with the given key and separator, possibly details,
     * and the default prefix and multiplicity
     * <p>
     * 
     * @param key
     *            The key for the option
     * @param details
     *            A boolean indicating whether details are expected for the
     *            option
     * @param separator
     *            The separator for the option
     *            <p>
    ...
    OptionSet addOption(String key, boolean details, Separator separator,
            boolean value, Multiplicity multiplicity) {
        ...
        if (multiplicity == null)
            throw new IllegalArgumentException(
                CLASS + ": multiplicity may not be null");

        if (separator == null)
            throw new IllegalArgumentException(
                CLASS + ": separator may not be null");
